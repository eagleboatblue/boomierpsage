...
namespace Boomi.Erp.Sage.Webapi.Server.Services
{
    public class ErpSageServiceProvider : IErpServiceProvider
    {
        private readonly ILogger logger;
        private readonly IDbManager dbManager;

        public ErpSageServiceProvider(ILogger logger, IDbManager dbManager)
        {
            this.logger = logger;
            this.dbManager = dbManager;
        }

        public async Task<SageResponse> CreateOrder(Metadata metadata, Order order)
        {
        ...
        private async Task<List<Product>> findMissedProducts(DatabaseRange databaseRange, List<Product> products)
        {
            var orderLinesRepo = this.dbManager.GetOrderLinesRepository(databaseRange);
